        ...
        <div className="container">
          ...
          <div id="aboutUsHeadDiv">
            ...
            >
              <h3>About Website</h3>
              <p>
                We are here to provide you latest study material for you
                Engineering course.
              </p>
              <div id="space"></div>
              <h3>About Our Team</h3>
              <p>
                Our team consist of Computer Science Engineering students, each
                of them have good development skills in web development field.
                This team is divide into two parts Frontend and Backend.
              </p>
            </div>
            <div id="getStartBtn">
        ...
        <div id="AboutCont" className="container">
          <div id="AboutCardRow1" className="row">
            <div id="IDCard" className="col-lg-4 col-md-4 col-12">
              <AboutUsCard
                socialLink="https://www.linkedin.com/in/ankit-kumar-27b863137"
                profileImage={image1}
                name="Ankit Kumar"
              />
            </div>
            <div id="IDCard" className="col-lg-4 col-md-4 col-12">
              <AboutUsCard
                socialLink="https://www.linkedin.com/in/anshul-maheshwari-194706194"
                profileImage={image2}
            ...
            <div id="IDCard" className="col-lg-4 col-md-4 col-12">
              <AboutUsCard
                socialLink="https://www.linkedin.com/in/sudhanshu2900"
                profileImage={image3}
          ...
          <div id="AboutCardRow1" className="row">
            <div id="IDCard" className="col-lg-6 col-md-6 col-12">
              <AboutUsCard
                socialLink="https://www.linkedin.com/in/tarun-mittal-034168167"
                profileImage={image4}
                name="Tarun Mittal"
              />
            </div>
            <div id="IDCard" className="col-lg-6 col-md-6 col-12">
              <AboutUsCard
                socialLink="https://www.linkedin.com/in/vishwas-patel-136a3316b"
                profileImage={image5}
                name="Vishwas Patel"
              />
            </div>
